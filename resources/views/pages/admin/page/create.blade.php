    ...
    <div class="block block-rounded">
        <form action="{{ route('admin.page.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="block-header d-md-flex align-items-center justify-content-between py-3 border-bottom">
                <h3 class="block-title">Page <small class="font-size-13">> Add</small></h3>
            ...
            <div class="block-footer pt-0 px-4 pb-4 text-center">
                <button type="submit" class="btn btn-success btn-sm px-3"><i class="bi bi-plus mr-1"></i> Publish</button>
            </div>
        </form>
    </div>
@endsection
