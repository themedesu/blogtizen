                ...
                columns: [
                    ...
                    {data: 'action', name: 'action', orderable: false, searchable: false,
                        render: function (data, type, row, meta) {
                            ...
                            let routeEdit = '{{route("admin.page.edit", ":id")}}';
                            let routeDelete = '{{route("admin.page.destroy", ":id")}}';
                            routeEdit = routeEdit.replace(':id', data[0]);
                            routeDelete = routeDelete.replace(':id', data[0]);
                            // then, passing to link
                            let actShow = `<div class="col-12 col-lg-4 pe-lg-1 mb-2 mb-lg-0"><a href="${data[2]}" target="_blank" class="btn btn-sm btn-outline-success w-100" data-bs-toggle="tooltip" data-bs-placement="left" title="View ${data[1]}"><i class="bi bi-folder2"></i></a></div>`;
                            let actEdit = `<div class="col-12 col-lg-4 px-lg-2 mb-2 mb-lg-0"><a href="${routeEdit}" class="btn btn-sm btn-outline-primary w-100" data-bs-toggle="tooltip" data-bs-placement="left" title="Edit ${data[1]}"><i class="bi bi-pencil-square"></i></a></div>`;
...
@section('content')
    <div class="block block-rounded">
        <div class="block-header d-md-flex align-items-center justify-content-between py-3 border-bottom">
            <h3 class="block-title">Page <small><i></i></small></h3>
            <a href="{{ route('admin.page.create') }}" class="btn btn-success font-size-12"> 
            ...
            <table class="table table-responsive table-vcenter js-dataTable-full" id="data-table">
                <thead>
                    <tr>
                        ...
                        <th class="text-center" style="vertical-align: middle;" width="40%">Title</th>
